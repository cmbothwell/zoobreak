...
You will need this abi representation for the server, which we will set up next. Note depending on your text editor you may need to strip the copied string from `ZOO.json` of the whitespace. 
...
Note to run background tasks you will need to open up other 
